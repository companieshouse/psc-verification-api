...
locals {
  ...
  service_name                = "psc-verification-api"
  container_port              = "8080"
  eric_port                   = "10000"
  docker_repo                 = "psc-verification-api"
  kms_alias                   = "alias/${var.aws_profile}/environment-services-kms"
  lb_listener_rule_priority   = 160
  lb_listener_paths           = ["/persons-with-significant-control-verification*","private/transactions/*/persons-with-significant-control-verification*"]
