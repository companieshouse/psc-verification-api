...
class InterceptorConfigTest {
    ...
    void addInterceptorsInvocations() {
        ...
        verify(interceptorRegistry, times(1)).addInterceptor(any(TokenPermissionsInterceptor.class));
    ...
    void addInterceptors() {
        ...
        verify(interceptorRegistry.addInterceptor(any(TokenPermissionsInterceptor.class))).order(3);
        verify(interceptorRegistry.addInterceptor(any(MappablePermissionsInterceptor.class))).order(4);
        ...
        verify(interceptorRegistry.addInterceptor(any(RequestLoggingInterceptor.class))
                .excludePathPatterns("/persons-with-significant-control-verification/healthcheck")).order(6);
    ...
    @Test
    void tokenPermissionInterceptor() {
        assertThat(testConfig.tokenPermissionsInterceptor(), isA(TokenPermissionsInterceptor.class));
    }
